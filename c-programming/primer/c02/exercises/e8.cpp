 ...
 *  call a second function named two(), and then display the word
 *  three on one line.
 *
 * The function two() should display the word two on one line.
 *
 * The main function shuold display the phrase starting now:
 *  before calling one_three() and display done! after calling it.
 *
